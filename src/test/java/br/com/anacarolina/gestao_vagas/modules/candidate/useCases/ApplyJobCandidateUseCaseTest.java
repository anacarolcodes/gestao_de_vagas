...
public class ApplyJobCandidateUseCaseTest {
    ...
    @Test
    public void should_not_apply_when_job_not_found(){
        try{
    ...
    @Test
    public void non_existent_candidate_should_not_apply_for_not_found_job(){
    ...
    public void should_be_abble_to_create_a_new_apply_job(){
        ...
        when(jobRepository.findById(idJob)).thenReturn(Optional.of(new JobEntities()));
