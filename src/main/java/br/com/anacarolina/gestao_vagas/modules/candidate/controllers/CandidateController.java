...
import br.com.anacarolina.gestao_vagas.modules.candidate.useCases.CreateCandidateUseCase;
...
public class CandidateController {
    ...
    @ApiResponses({@ApiResponse(responseCode = "200", content = {
            ...
            @Schema(implementation = JobEntities.class))) // qual é o modelo de objetos que está nessa lista
    })})
            public List<JobEntities> findJobByFilter(@RequestParam String filter){
